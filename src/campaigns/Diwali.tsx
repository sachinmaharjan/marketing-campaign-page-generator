...
export default function Diwali() {
  return (
    <div className="min-h-full bg-[#3D0C11] text-[#F3E5D8] font-serif overflow-x-hidden relative">
      {/* Background Motifs */}
      ...
      <footer className="py-12 border-t border-[#D4AF37]/10 text-center text-[#D4AF37]/60 text-sm font-sans uppercase tracking-[0.15em] mb-20">
